...
mcmc.prosse <- function(lik, tree, species.name, unknown.tip, unknown.list=NULL, x.init, nstepsw=0, nsteps, w, prior=NULL,
  ...
  mcmc.loop <- function() {
    ...
    w <- diff(sapply(tmp[2:4],quantile,c(0.025,0.975)))
	}
